...
class ListFilmAdapter (private val listFilm: ArrayList<Film>) : RecyclerView.Adapter<ListFilmAdapter.ListViewHolder>(){
    ...
    private lateinit var onItemClickCallback: ListFilmAdapter.OnItemClickCallback

    fun setOnItemClickCallback(onItemClickCallback: ListFilmAdapter.OnItemClickCallback) {
